...
For more information, be sure to check out our [CASTAPRIVA Documentation](https://docs.openwebui.com/).

## Key Features of CASTAPRIVA ⭐
...
- 🧩 **Plugin Support**: Extend CASTAPRIVA with **Filters**, **Actions**, **Pipes**, **Tools**, and **Skills**. Connect external services through **MCP**, **MCPO**, and **OpenAPI tool servers**. Build custom integrations, rate limits, approval flows, data connections, and more.

- 🤖 **Models & Agents**: Wrap any base model with custom instructions, tools, and knowledge to build specialized agents. Supports dynamic variables, per-user/group access control, and community preset imports via [CASTAPRIVA Community](https://openwebui.com/).
...
- 🌐🌍 **Multilingual Support**: Use CASTAPRIVA in your preferred language with i18n support. We're actively seeking contributors to expand language coverage!

- 🌟 **Continuous Updates**: We're committed to improving CASTAPRIVA with regular updates, fixes, and new features.
...
Want to learn more about CASTAPRIVA's features? Check out our [CASTAPRIVA documentation](https://docs.openwebui.com/features) for a comprehensive overview!

## The CASTAPRIVA Ecosystem 🌐

CASTAPRIVA is the core, surrounded by companion apps and infrastructure that extend what your AI can do, where it can reach, and how you run it:

- 💻 **CASTAPRIVA Computer** ([open-webui/computer](https://github.com/open-webui/computer)): A standalone, mobile-first computer and coding agent that runs on the machine you own. Files, terminal, and git in a browser tab, reachable from your phone. Connect it into CASTAPRIVA as a model, or reach it from Telegram, WhatsApp, and more.

- ⚡ **Open Terminal** and **Terminals (Enterprise)** ([open-webui/open-terminal](https://github.com/open-webui/open-terminal) & [open-webui/terminals](https://github.com/open-webui/terminals)): A self-hosted computing environment that plugs into CASTAPRIVA, giving the AI a place to write code, run it, read output, fix errors, and iterate inside the chat. Terminals gives you per-user isolated containers with separate credentials, resource limits, and network rules. Automatic lifecycle management on Docker or Kubernetes.
...
- 🖥️ **Native Desktop App** ([open-webui/desktop](https://github.com/open-webui/desktop)): Run CASTAPRIVA as a native app on macOS, Windows, and Linux. System-wide Spotlight chat bar with screenshot capture, push-to-talk voice, and optional fully-local inference via a built-in llama.cpp engine.

Want to learn more? Check out our [CASTAPRIVA documentation](https://docs.openwebui.com) for more details!
...
CASTAPRIVA can be installed using pip, the Python package installer. Before proceeding, ensure you're using **Python 3.11** to avoid compatibility issues.

1. **Install CASTAPRIVA**:
   Open your terminal and run the following command to install CASTAPRIVA:

   ```bash
   pip install open-webui
   ```

2. **Running CASTAPRIVA**:
   After installation, you can start CASTAPRIVA by executing:

   ```bash
   open-webui serve
   ```

This will start the CASTAPRIVA server, which you can access at [http://localhost:8080](http://localhost:8080)
...
This installation method uses a single container image that bundles CASTAPRIVA with Ollama, allowing for a streamlined setup via a single command. Choose the appropriate command based on your hardware setup:
...
After installation, you can access CASTAPRIVA at [http://localhost:3000](http://localhost:3000). Enjoy! 😄

### Other Installation Methods

We offer various installation alternatives, including non-Docker native installation methods, Docker Compose, Kustomize, and Helm. Visit our [CASTAPRIVA Documentation](https://docs.openwebui.com/getting-started/) or join our [Discord community](https://discord.gg/5rJgQTnV4s) for comprehensive guidance.

### Troubleshooting

Encountering connection issues? Our [CASTAPRIVA Documentation](https://docs.openwebui.com/troubleshooting/) has got you covered. For further assistance and to join our vibrant community, visit the [CASTAPRIVA Discord](https://discord.gg/5rJgQTnV4s).

#### CASTAPRIVA: Server Connection Error
...
Check our Updating Guide available in our [CASTAPRIVA Documentation](https://docs.openwebui.com/getting-started/updating).
...
If you are running CASTAPRIVA in an offline environment, you can set the `HF_HUB_OFFLINE` environment variable to `1` to prevent attempts to download models from the internet.
...
Discover upcoming features on our roadmap in the [CASTAPRIVA Documentation](https://docs.openwebui.com/roadmap/).

## License 📜

This project contains code under multiple licenses. The current codebase includes components licensed under the CASTAPRIVA License with an additional requirement to preserve the "CASTAPRIVA" branding, as well as prior contributions under their respective original licenses. For a detailed record of license changes and the applicable terms for each section of the code, please refer to [LICENSE_HISTORY](./LICENSE_HISTORY). For complete and updated licensing details, please see the [LICENSE](./LICENSE) and [LICENSE_HISTORY](./LICENSE_HISTORY) files.

## Support 💬

If you have any questions, suggestions, or need assistance, please open an issue or join our
[CASTAPRIVA Discord community](https://discord.gg/5rJgQTnV4s) to connect with us! 🤝

## Security 🛡️

If you believe you've found a security vulnerability, or something that shouldn't be disclosed publicly, please [reach out confidentially through our responsible disclosure program on GitHub](https://github.com/open-webui/open-webui/security). We accept reports only through GitHub, not through any other platform. Thank you for helping us keep CASTAPRIVA secure!
...
Created by [Timothy Jaeryang Baek](https://github.com/tjbck) - Let's make CASTAPRIVA even more amazing together! 💪
